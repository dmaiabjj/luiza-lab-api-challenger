...
from app import db
from app.domain.repository.interfaces.abstract_repository_crud_action import AbstractRepositoryCRUDAction


class DataBaseRepository(AbstractRepositoryCRUDAction):
